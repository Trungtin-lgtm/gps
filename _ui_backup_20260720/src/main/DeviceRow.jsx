...
const useStyles = makeStyles((theme) => ({
  ...
  row: {
    margin: theme.spacing(0.4, 0.75),
    borderRadius: theme.spacing(1.25),
    border: '1px solid transparent',
    color: '#e5edf6',
    '& .MuiListItemText-secondary': { color: '#91a0b2' },
    '&:hover': { backgroundColor: 'rgba(34, 211, 238, 0.06)' },
    '&.Mui-selected': {
  ...
  return (
    <div style={style}>
      ...
      >
        <ListItemAvatar>
          <Avatar sx={{
            bgcolor: item.status === 'online' ? 'info.main' : 'neutral.main',
            width: 38,
            height: 38,
            boxShadow: item.status === 'online' ? '0 0 0 4px rgba(22,119,255,0.12)' : 'none',
          }}>
