...
const MainToolbar = ({
  ...
  const handleRedirect = () => {
    // const newUrl = `${protocol}//${ipOrDomain}:9091`;
    const newUrl = `http://gps-mic.aipt.vn`;
  ...
  return (
    <Toolbar ref={toolbarRef} className={classes.toolbar}>
      ...
      >
        {desktop
          ? (devicesOpen ? <PhonelinkOffIcon /> : <PhonelinkOffIcon />)
          : (devicesOpen ? <PhonelinkOffIcon /> : <PhonelinkIcon />)
        }
      </IconButton>}
      <OutlinedInput
        ref={inputRef}
        ...
        size="small"
        fullWidth
        sx={{ bgcolor: '#111827', borderRadius: 2, color: '#e5edf6' }}
      />
      <Popover
