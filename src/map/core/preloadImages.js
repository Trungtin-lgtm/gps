...
import defaultSvg from '../../resources/images/icon/gps.png';
...
export default async () => {
  ...
  ['info', 'success', 'warning', 'error', 'neutral'].forEach((color) => {
    mapImages[`marker-${color}`] = prepareStatusMarker(mapPalette[color].main);
    mapImages[`marker-${color}-selected`] = prepareStatusMarker(mapPalette[color].main, true);
  });
