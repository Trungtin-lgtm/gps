...
export default () => {
  ...
  return useMemo(() => [
    ...
    },
    {
      ...
      style: styleCustom({
        tiles: googleKey ? [`google://roadmap/{z}/{x}/{y}?key=${googleKey}`] : [],
        maxZoom: 20,
    ...
    },
    {
      ...
      style: styleCustom({
        tiles: googleKey ? [`google://satellite/{z}/{x}/{y}?key=${googleKey}`] : [],
        maxZoom: 20,
        attribution: '© Google Maps',
      }),
      available: Boolean(googleKey),
    ...
    },
    {
      ...
      style: styleCustom({
        tiles: googleKey ? [`google://satellite/{z}/{x}/{y}?key=${googleKey}&layerType=layerRoadmap`] : [],
        maxZoom: 20,
        attribution: '© Google Maps',
      }),
      available: Boolean(googleKey),
