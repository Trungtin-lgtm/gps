...
const PreferencesPage = () => {
  ...
  return (
    <PageLayout menu={<SettingsMenu />} breadcrumbs={['settingsTitle', 'settingsDisplayMap']}>
      <Container className={classes.container} style={{ backgroundColor: '#cccc', paddingTop: '20px' }}>
        {!readonly && (
          <>
