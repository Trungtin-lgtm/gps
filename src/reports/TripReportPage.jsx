...
const TripReportPage = () => {
  ...
  const [storedColumns, setColumns] = usePersistedState(
    'tripColumns',
    ['startTime', 'startAddress', 'endTime', 'endAddress', 'distance', 'duration'],
  );
  const columns = storedColumns.filter((key) => !['averageSpeed', 'maxSpeed'].includes(key));
