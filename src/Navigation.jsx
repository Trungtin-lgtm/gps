...
const Navigation = () => {
  ...
  const readonly = useSelector((state) => !state.session.user?.administrator && Boolean(
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<App />}>
        ...
        <Route path="replay" element={<Navigate to="/reports/route" replace />} />
        ...
        <Route path="reports">
          ...
          <Route path="trip" element={<Navigate to="/reports/route" replace />} />
          <Route
            path="scheduled"
            element={readonly ? <Navigate to="/reports/summary" replace /> : <ScheduledPage />}
          />
          <Route
            path="statistics"
            element={administrator ? <StatisticsPage /> : <Navigate to="/reports/summary" replace />}
          />
          <Route
            path="logs"
            element={administrator ? <LogsPage /> : <Navigate to="/reports/summary" replace />}
          />
        </Route>
      </Route>
    </Routes>
