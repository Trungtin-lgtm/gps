    ...
    <div style={{overflow:'auto', overflowX:'hidden', color:'black'}}>
      <List>
        <MenuItem
          ...
          icon={ <Tooltip title={t('sharedPreferences')}><DisplaySettingsIcon sx={{ color: 'black' }} /></Tooltip>}
        ...
        {!readonly && (
          <>
            <MenuItem
              ...
              icon={ <Tooltip title={t('sharedNotifications')}><NotificationsNoneIcon sx={{ color: 'black' }} /></Tooltip>}
        ...
        <>
          ...
          <List>
            <MenuItem
              ...
              icon={ <Tooltip title={t('serverAnnouncement')}><CampaignIcon sx={{ color: 'black' }} /></Tooltip>}
