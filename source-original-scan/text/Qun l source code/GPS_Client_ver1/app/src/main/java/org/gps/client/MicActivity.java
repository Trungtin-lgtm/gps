...
public class MicActivity extends AppCompatActivity {
    private static String TAG = "MicActivity";
...
//        checkRecordPermission();
        ...
        btnStream.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (mBoundService.isStreaming()){
                    ...
                    Log.i(TAG, editTextThreshold.getText().toString());
                    ...
                    mBoundService.setVoiceThreshold(Integer.parseInt(editTextThreshold.getText().toString()));
                    SharedPreferences prefs = getSharedPreferences("settings", MODE_PRIVATE);
                    SharedPreferences.Editor editor = prefs.edit();
                    try {
                        int threshold = Integer.parseInt(editTextThreshold.getText().toString());
                        editor.putInt("voiceThreshold", threshold);
                        editor.putBoolean("voiceDetectionEnabled", threshold > 0); // Bật nếu khác 0
                    } catch (NumberFormatException e) {
                        editor.putInt("voiceThreshold", 0);
                        editor.putBoolean("voiceDetectionEnabled", false);
                    }
                    editor.apply();
        ...
        editTextThreshold.setEnabled(false);
            ...
            public void run() {
                if(mBoundService != null) {
                    ...
                    if (!spinnerPayloadType.isEnabled()) {
                        ...
                        if (!editTextThreshold.isEnabled()){
                            editTextThreshold.setText(String.valueOf(mBoundService.getVoiceThreshold()));
                        }
                    }
                    if (mBoundService.isStreaming()) {
                        btnStream.setText("Stop");
                        ...
                        editTextThreshold.setEnabled(true);
                    }
